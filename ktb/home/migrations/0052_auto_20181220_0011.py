# Generated by Django 2.0 on 2018-12-19 18:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratePMT', models.FloatField(null=True)),
                ('commissionAgent', models.CharField(max_length=255)),
                ('commissionRate', models.FloatField(null=True)),
                ('logisticProvider', models.CharField(max_length=255)),
                ('estimatedLogisticsCost', models.FloatField(null=True)),
