# Generated by Django 2.0 on 2019-01-04 11:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('po_date', models.CharField(blank=True, max_length=255, null=True)),
                ('so_number', models.CharField(blank=True, max_length=255, null=True)),
                ('so_date', models.CharField(blank=True, max_length=255, null=True)),
                ('manager1', models.CharField(blank=True, max_length=255, null=True)),
                ('manager2', models.CharField(blank=True, max_length=255, null=True)),
                ('approve1', models.BooleanField()),
                ('approve2', models.BooleanField()),
                ('approve1date', models.CharField(blank=True, max_length=255, null=True)),
                ('approve2date', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='TradeRefNo',
