...
urlpatterns = [
    ...
    url(r'^getextra/',views.ExtrasHelper,name='extrashelper'),
     url(r'^getstockinventory/',views.GetStockInventory,name='getStockInventory'),
...
#new --------------------------------------
    ...
    url(r'^exportlogisticdue/',views.ExportLogisticDue, name='exportLogisticDue'),
    url(r'^exportcomissiondue/',views.ExportComissionDue, name='exportComissionDue'),
...
# alter value -----------------------
    ...
    url(r'^exportdashinv/',views.ExportDashInventory,name='exportdashinventory'),
    url(r'^exportstockjournal/',views.ExportStockJournal,name='exportStockJournal'),
